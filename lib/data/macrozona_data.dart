...
const kPatagoniaParrafos = [
  ...
  Parrafo(
    texto:
        "Si te apasiona el trekking, las Torres del Paine son tu norte: bosques, cerros, saltos de agua, lagos y vistas privilegiadas a los Campos de Hielo Sur serán parte de tu experiencia.",
  ),
  Parrafo(
    texto:
...
const kPatagoniaLugares = [
  ...
  Lugar(
    destino: "Lago General Carrera",
    imagen: "assets/images/patagonia_2.jpg",
  ),
  ...
  Lugar(
    destino: "Coyhaique y Puerto Aysén",
    imagen: "assets/images/patagonia_7.jpg",
  ),
...
const kPatagoniaExperiencias = [
  ...
  Experiencia(
    ...
    descripcion: Parrafo(
      texto:
          'Ajetreada vida nocturna, modernos centros comerciales, productos textiles y gastronómicos típicos de Chile y mucho más.',
    ),
  ),
  Experiencia(
    titulo: 'Termas y bienestar',
    descripcion: Parrafo(
      texto:
          '¿Te imaginas sumergido en calientes aguas termales mientras la lluvia cae sobre los frondosos bosques a tu alrededor?',
    ),
  ),
  Experiencia(
    titulo: 'Cruceros y navegaciones',
    descripcion: Parrafo(
      texto:
          '¿Buscas vivir una experiencia única, rodeado de paisajes escénicos y con las comodidades propias de un rey?',
    ),
  ),
  Experiencia(
    titulo: 'Astroturismo',
    descripcion: Parrafo(texto: '¡Vive un viaje a las estrellas en Chile!'),
  ),
  Experiencia(
    titulo: 'Cultura',
    descripcion: Parrafo(
  ...
  Experiencia(
    titulo: 'Vinos y Gastronomía',
    descripcion: Parrafo(
      texto:
          'Una combinación de exquisitos productos del mar y gran variedad de alimentos provenientes de la tierra…',
    ),
  ),
  Experiencia(
    titulo: 'Aventura y deporte',
    descripcion: Parrafo(
  ...
  Experiencia(
    ...
    descripcion: Parrafo(
      texto:
          'Hay pocos lugares en el mundo donde puedes disfrutar vistas tan diversas como en Chile…',
    ),
  ),
];
...
const kPatagoniaClima = Clima(
  ...
  parrafo: Parrafo(
    texto:
        'La información corresponde a - Av. Pdte. Eduardo Frei Montalva 768, Punta Arenas, Magallanes y la Antártica Chilena, Chile',
  ),
);
